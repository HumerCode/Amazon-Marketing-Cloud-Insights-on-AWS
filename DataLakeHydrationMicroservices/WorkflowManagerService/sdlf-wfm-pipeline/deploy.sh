...
LIBRARY_TABLE_NAME="$MICROSERVICE_NAME-$TEAM_NAME-$PIPELINE_NAME-AMCWorkflowLibrary"
echo $LIBRARY_TABLE_NAME
python3 ./initial-load-AmcWorkflowLibrary.py $LIBRARY_TABLE_NAME
