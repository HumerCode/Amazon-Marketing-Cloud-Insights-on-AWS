...
function deploy_wfm_foundations()
{
...
if $fflag
then
    echo "Deploying WFM foundational repositories..." >&2
    declare -a REPOSITORIES=("sdlf-wfm-pipeline")
    deploy_wfm_foundations
    STACK_NAME=sdlf-${TEAM}-cicd-wfm-repos
    aws cloudformation create-stack \
        --stack-name ${STACK_NAME} \
        --template-body file://${DIRNAME}/nested-stacks/template-cicd-wfm.yaml \
        --parameters \
            ...
            ParameterKey=pRepositoryName,ParameterValue=sdlf-wfm-pipeline \
