...
class CustomTransform():
    ...
    def transform_object(self, bucket, keys, team, dataset):
        ...
        silver_catalog = ssm.get_parameter(
            Name='/Orion/Glue/{}/{}/StageDataCatalog'.format(team, dataset),
            WithDecryption=True
        ...
        try :
            gold_catalog = ssm.get_parameter(
              Name='/Orion/Glue/{}/{}/AnalyticsDataCatalog'.format(team, dataset),
              WithDecryption=True
             ).get('Parameter').get('Value')
        ...
        job_name = 'orion-{}-{}-glue-job'.format(team,dataset)  # Name of the Glue Job
