...
# class PlatformManagerSagemaker(Stage):
#     def __init__(
#         self,
#         scope: Construct,
#         environment_id: str,
...
#         **kwargs: Any,
#     ) -> None:
#         super().__init__(scope, f"orion-{environment_id}-platform-manager-microservice", **kwargs)
        
#         self._params = params
#         self._team = self._params.get("team", "demoteam")

#         PlatformManagerSageMaker(self, "orion-platform-manager", environment_id=environment_id, team=self._team, microservice="platform-manager")

# class TenantProvisiongServiceStage(Stage):
#     def __init__(
#         self,
#         scope: Construct,
#         environment_id: str,
...
#         **kwargs: Any,
#     ) -> None:
#         super().__init__(scope, f"orion-{environment_id}-tps-microservice", **kwargs)

#         self._params = params
#         self._team = self._params.get("team", "demoteam")
#         self._pipeline = self._params.get("pipeline", "cmpl")

#         TenantProvisiongService(self, "orion-tps", environment_id=environment_id, team=self._team, microservice="tps", pipeline=self._pipeline)

# class WorkFlowManagerServiceStage(Stage):
#     def __init__(
#         self,
#         scope: Construct,
#         environment_id: str,
...
#         **kwargs: Any,
#     ) -> None:
#         super().__init__(scope, f"orion-{environment_id}-wfm-microservice", **kwargs)

#         self._params = params
#         self._team = self._params.get("team", "demoteam")
#         self._pipeline = self._params.get("pipeline", "dlhs")
#         self._dataset = self._params.get("dataset", "amcdataset")

#         WorkFlowManagerService(self, "orion-wfm", environment_id=environment_id, team=self._team, microservice="wfm", pipeline=self._pipeline, dataset=self._dataset)
...
(
    ...
    # .add_stage("dev", TenantProvisiongServiceStage(satellite_app, environment_id="dev", env=config.get_env("dev"), params=params.get_tps_params()), execute_tests=False)
    # .add_stage("dev", WorkFlowManagerServiceStage(satellite_app, environment_id="dev", env=config.get_env("dev"), params=params.get_wfm_params()), execute_tests=False)
    # .add_stage("dev", PlatformManagerSagemaker(satellite_app, environment_id="dev", env=config.get_env("dev"),params=params.get_platform_manager_params()), execute_tests=False)
