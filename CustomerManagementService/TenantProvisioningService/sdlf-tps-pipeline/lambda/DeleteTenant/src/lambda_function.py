#!/usr/bin/env python3
# File Name: DeleteTenant/src/lambda_function.py
# Author: Tejal Gohil gohiteja@amazon.com
# Description:
# The Lambda function to perform delete operations on tps-tenant table.
...
def delete_item(table, key):
    try:
        response = table.delete_item(
            ...
            # ConditionExpression=f"attribute_exists({key['tenantId']})",
        )
