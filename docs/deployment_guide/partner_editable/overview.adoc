This guide provides instructions for deploying the Amazon Marketing Cloud (AMC) Insights on AWS solution using AWS Cloud Development Kit (AWS CDK) and AWS DataOps Development Kit (DDK). 
