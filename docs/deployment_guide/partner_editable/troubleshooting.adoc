//TODO Troy, Somehow in your PR, the content that was in this file ("troubleshooting.adoc") got overwritten by a duplicate of what's in pre_deployment.adoc. Would you please restore the "Troubleshooting" section and address any issues? It included these two notes:

//TODO Troy, What do we mean by "AMC user interface"? —from Troy: Getting Clarification
//TODO Troy, How do people raise a ticket to the AMC team? —from Troy: Getting Clarification
