...
. In your integrated development environment (IDE), download the https://fwd.aws/Rp8mK?[{partner-product-short-name} repository^], upload it to your AWS Cloud9 instance, and unzip it.
+
...
=== Clone the {partner-product-short-name} repo

Clone the https://fwd.aws/Rp8mK?[{partner-product-short-name} repository^] as follows, replacing the information in brackets.
...
Deploying this AWS Solution takes about {deployment_time} to complete.
