...
[#DeploymentSteps1]
.Quick Start Deployment Steps for {partner-product-short-name} on AWS
image::../docs/deployment_guide/images/AMC-QuickStart-Deploy.png[AMC Quickstart Deployment Steps,width=648,height=439]
